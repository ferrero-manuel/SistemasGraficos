class Crane {
    constructor(shaderProgram) {
        ...
        this.segment_A_node.setScale(4, 12, 4);
        this.segment_A_node.setPosition(0, 6, 0);
        ...
        this.segment_B_node.setScale(3, 12, 3);
        this.segment_B_node.setPosition(0, 12, 0);
        ...
        this.segment_C_node.setScale(1, 12, 1);
        this.segment_C_node.setPosition(0, 12, 0);

        this.aCabin = new Cabin();
        this.segment_D_node = this.aCabin.getNode();
        this.segment_D_node.setParent(this.segment_C_node);
        this.segment_D_node.setPosition(0, 7.5, 0);
    ...
    rotateHand(angle) {
        ...
        // considerar las translaciones del segmento f para el g.
    ...
    extendBase(value) {
        ...
        this.segment_B_node.setPosition(0, 12*this.extension, 0);
        this.segment_C_node.setPosition(0, 12*this.extension, 0);
    }
    ...
    extendWire(value) {
        ...
        this.rotateHand(this.handAngle);
    }
