class Edifice {
    constructor(numWinWidth, numWinLong, floors_1, floors_2, perimetralCols) {
        ...
        this.shaderProgramCubeMap = {};
        this.textures = [];
        this.cubeMapTexture = {};
        this.columnTexture = [];
    }

    setShaderProgram(shaderProgramBasic, shaderProgramTextures, textures, shaderProgramCubeMap, cubeMapTexture) {
        this.shaderProgramBasic = shaderProgramBasic;
        this.shaderProgramTextures = shaderProgramTextures;
        this.textures = textures;
        this.shaderProgramCubeMap = shaderProgramCubeMap;
    ...
    build() {
        ...
        for (let floor = 0; floor < this.floors_1; floor++) {
            ...
            elevatorNode.setShaderProgramTexture(this.shaderProgramTextures, this.textures, 0);
            ...
            let close_long = this.winSize*this.numWinLong;
            let close_width = this.winSize*this.numWinWidth;
            let aWindow = new Window();
            let aWindowNode = new Node();
            aWindowNode.setGeometry(aWindow);
            aWindowNode.setShaderProgramCubeMap(this.shaderProgramCubeMap, this.cubeMapTexture);
            aWindowNode.setParent(aNode);
            aWindowNode.setPosition(0, 2, close_width/2);
            aWindowNode.setScale(close_long, 4, 1);
            
            aWindowNode = new Node();
            aWindowNode.setGeometry(aWindow);
            aWindowNode.setShaderProgramCubeMap(this.shaderProgramCubeMap, this.cubeMapTexture);
            aWindowNode.setParent(aNode);
            aWindowNode.setPosition(0, 2, -close_width/2);
            ...
            aWindowNode.setShaderProgramCubeMap(this.shaderProgramCubeMap, this.cubeMapTexture);
            aWindowNode.setParent(aNode);
            aWindowNode.setPosition(close_long/2, 2, 0);
            aWindowNode.setRotation(0, 90, 0);
            aWindowNode.setScale(close_width, 4, 1);
        ...
        for (let floor = 0; floor <= this.floors_2; floor++) {
            ...
            if (floor != this.floors_2) {
                let close_long = this.winSize*(this.numWinLong - 2);
                let close_width = this.winSize*(this.numWinWidth - 2);
                let aWindow = new Window();
                let aWindowNode = new Node();
                aWindowNode.setGeometry(aWindow);
                aWindowNode.setShaderProgramCubeMap(this.shaderProgramCubeMap, this.cubeMapTexture);
    ...
    _buildLowLevel() {
        ...
        lowLevelNode.setShaderProgramTexture(this.shaderProgramTextures, this.textures, 0);
        ...
        lowLevelRightNode.setShaderProgramTexture(this.shaderProgramTextures, this.textures, 0);
        ...
        lowLevelLeftNode.setShaderProgramTexture(this.shaderProgramTextures, this.textures, 0);
